 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 Daniel = new Person1("Daniel");
		  toPrint += p1.toString("drobertson35");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Harry Wang");
		  toPrint += p2.toString("hwang703");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Kyle Cozzone");
		  toPrint += p3.toString("kcozzone3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Evan");
                  toPrint += p4.toString("ejuncal3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
<<<<<<< HEAD
                  Person5 p5 = new Person5("Jackson");
                  toPrint += p5.toString("903128693");
		  
=======
                  Person5 p5 = new Person5("P5");
                  toPrint += p5.toString("gburdell5");

>>>>>>> 584ea6ea7771df0eeeff0c87ad31ebf51e10fee5
